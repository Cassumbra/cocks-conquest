...
fn main () {
    ...
    .add_system_set(
        SystemSet::new()
            .label("actor_turn")
            .after("update_turn")
            .with_system(status_effects::tranced_behaviour.run_in_state(GameState::Playing).label("trance"))
            .with_system(wander_behaviour::wander_behaviour.run_in_state(GameState::Playing).after("trance"))
