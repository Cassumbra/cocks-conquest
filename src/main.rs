...
fn main () {
    ...
    .add_system_set(
        SystemSet::new()
            ...
            .with_system(melee_behavior::melee_behavior.run_in_state(GameState::Playing).label("melee").after("trance").after("targetting"))
            .with_system(wander_behavior::wander_behavior.run_in_state(GameState::Playing).after("melee"))
